...
The obtcd fork registers OBTC observability command and result types for
listing expiring UTXOs, expiry index statistics, REAP dry-run planning, and
expiry commitment state.
