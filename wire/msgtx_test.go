...
func TestTxSerialize(t *testing.T) {
	...
	tests := []struct {
		...
		// Multiple outputs regular witness transaction.
		{
			multiWitnessTx,
			multiWitnessTx,
		...
		// Multiple outputs tax witness transaction.
		{
			multiTaxWitnessTx,
			multiTaxWitnessTx,
			multiTaxWitnessTxEncoded,
			multiWitnessTxPkScriptLocs,
			true,
		},
	}
...
var multiTaxWitnessTxEncoded = []byte{
	0x1, 0x0, 0x0, 0x0, // Version
	0x0,  // Marker byte indicating 0 inputs, or a segwit encoded tx
	0x11, // Flag byte
	0x1,  // Varint for number of inputs
